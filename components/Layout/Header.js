          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                            ...
                                            {category.products.map((product, prodIndex) => (
                                              <div className="row align-items-center">
                                                ...
                                                <div className="col-7">
                                                  ...
                                                  <div className="">
                                                    <Link className="learn-more" href={product.link}>
                                                      Learn More <img src="/images/icons/greater-arrow-right.svg" />
                                                    </Link>
                                                  </div>
                                                </div>
                                              </div>
                                    ...
                                    <div className="box" key={subCatIndex}>
                                      ...
                                      <ul className="item-lists">
                                        {subCategory.products.map((product, prodIndex) => (
                                          <li key={prodIndex}>
                                            <div className="image">
                                              <Image width={38} height={64} src={product.image} alt={product.name} />
                                            </div>
                                            <div>
                                              <div className="title">{product.name}</div>
                                              <Link className="learn-more" href={product.link}>
            ...
            <div className="d-flex align-items-center search-dropdown-header">
              <form className="d-flex header-search" role="search">
                ...
                <Link href="" className="" type="submit">
                  <Image width={20} height={20} src="/images/icons/search-icon.svg" />
                </Link>
              </form>
              <div className="select-country relative w-64">
                <div className="customSelect cursor-pointer" onClick={() => setIsOpen(!isOpen)}>
                  <div className="selectedOption flex items-center">
                    <img src={selectedOption.img} alt={selectedOption.label} className="w-5 h-5 me-2" />
              ...
              <div className="select-country select-language relative w-64">
                <div className="customSelect cursor-pointer" onClick={() => setIsOpenLangauge(!isOpenLangauge)}>
                  <div className="selectedOption flex items-center">
                    <img src={selectedOptionLangauge.img} alt={selectedOptionLangauge.label} className="w-5 h-5 me-2" />
              ...
              <div className="signinsignup-wrap d-none">
                <Link className="signinsignup" href="">
                  {" "}
                  Sign in/Sign up <img src="/images/icons/arrow-right.svg" alt="" />{" "}
                </Link>
              </div>
            </div>
