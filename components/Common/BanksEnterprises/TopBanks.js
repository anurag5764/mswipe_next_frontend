...
const TopBanks = () => {
    ...
    const solutionSetData = [
        {
            img: "/images/banks-logo/01.svg",
        },
        {
            img: "/images/banks-logo/02.svg",
        },
        {
            img: "/images/banks-logo/03.svg",
        },
        {
            img: "/images/banks-logo/04.svg",
        },
        {
            img: "/images/banks-logo/05.svg",
        },
        {
            img: "/images/banks-logo/06.svg",
        },
        {
            img: "/images/banks-logo/07.svg",
        },
        {
            img: "/images/banks-logo/08.svg",
        },
        {
            img: "/images/banks-logo/01.svg",
        },
        ...
        <section className='top-brands-section'>
            ...
            <div className='row text-center'>
                    <div className='col-12'>
                        <h2 className='head01'>Empowering <strong>70+ top banks</strong></h2>
                    </div>
                </div>
                <div className='row'>
                    <div className='col-12'>
